...
from crawler_weather.config import CITIES
from crawler_weather.fetcher import _delay, fetch_city_weather
from crawler_weather.parser import parse_7d_forecast
from crawler_weather.storage import save_data
...
def main():
    ...
    logger.info("crawler_weather 天气爬虫启动")
    ...
    logger.info("crawler_weather 天气爬虫运行结束")
